...
🧠 Interactive visualizations of neural network architectures and 42 foundational ML papers
...
- **Total Papers**: 42 foundational works in deep learning
...
### 🔥 Attention & Transformers (6 papers)
...
### 👁️ Vision Transformers & Multimodal (4 papers)
| Paper | Year | Description |
|-------|------|-------------|
| **ViT** | 2020 | An Image is Worth 16x16 Words |
| **CLIP** | 2021 | Learning Transferable Visual Models |
| **MAE** | 2021 | Masked Autoencoders for Computer Vision |
...
### 🎯 Object Detection & Segmentation (3 papers)
| Paper | Year | Description |
|-------|------|-------------|
...
### 🏗️ Efficient Architectures (4 papers)
| Paper | Year | Description |
|-------|------|-------------|
